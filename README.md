...
This project was developed as part of my Mechanics of Solids and Fluids course to convert theoretical calculations into a computational solution.

A full-stack engineering application designed to analyze and solve **three composite bar problems** using principles of equilibrium and compatibility.  
This platform combines a powerful **Python backend (FastAPI)** with an interactive **React + Tailwind frontend** to deliver accurate results and a smooth user experience.
